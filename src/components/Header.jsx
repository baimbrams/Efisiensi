    ...
    <Navbar className="w-screen max-w-none shadow-none px-4 py-2 lg:py-4">
        ...
        <div className="hidden items-center gap-x-2 lg:flex">
          <div className="relative flex w-full gap-2 md:w-max">
            <Input
              ...
              className=" !border-t-blue-gray-300 pl-9 placeholder:text-blue-gray-300 focus:border-[#FFA812]"
              labelProps={{
      ...
      <MobileNav open={openNav}>
        <div className="container mx-auto">
          <div className="flex mt-4 flex-col gap-x-2 sm:flex-row sm:items-center">

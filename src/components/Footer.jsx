		...
		C276.546,215.678,222.799,268.994,156.734,268.994z"
              ...
              <div className="mt-4 px-8 grid grid-cols-2 lg:grid-cols-4 place-content-center">
                <span className="inline-flex w-full items-center">
                  <a
                    href="https://www.instagram.com/busefisiensi/"
                    type="button"
                ...
                <span className="inline-flex w-full items-center">
                  <a
                    href="https://www.tiktok.com/@busefisiensi"
                    type="button"
                    className="m-1 h-9 w-9 rounded-full border-2 border-white uppercase leading-normal text-white transition duration-150 ease-in-out hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0"
                    data-te-ripple-init
                    data-te-ripple-color="light"
                ...
                <span className="inline-flex w-full items-center">
                  <a
                    href="https://www.youtube.com/@BUSEFISIENSIOFFICIAL"
                    type="button"
                    className="m-1 h-9 w-9 rounded-full border-2 border-white uppercase leading-normal text-white transition duration-150 ease-in-out hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0"
                    data-te-ripple-init
                    data-te-ripple-color="light"
                  ...
                  >
                    Bus Efisiensi Official
                  </a>
                </span>

                <span className="inline-flex w-full items-center">
                  <a
                    href="https://web.facebook.com/PO.EFISENSI"
                    type="button"
                    className="m-1 h-9 w-9 rounded-full border-2 border-white uppercase leading-normal text-white transition duration-150 ease-in-out hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0"
                    data-te-ripple-init
                    data-te-ripple-color="light"

...
const Footer = () => {
  return (
    <>
      <footer className="flex flex-col items-center bg-neutral-100 text-center dark:bg-yellow-600 lg:text-left">
        <div className="container p-6 pl-12 text-neutral-800 dark:text-neutral-200">
          <div className="grid gap-4 lg:grid-cols-2">
            ...
            <div className="mb-6 md:mb-0">
              <div className="w-full grid place-content-center">
                ...
                <p className="mt-1">0878-3900-0400</p>
              </div>
